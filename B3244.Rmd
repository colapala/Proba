...
les $p_{valeur}$ des diff?rents algorithmes sont:
...
interpr?tation: si la $p_{valeur}$ est inferieure a 0.01 alors la sequence n'est pas aleatoire. Sinon, on ne peut pas conclure.
